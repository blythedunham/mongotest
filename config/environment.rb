...
mongo_config_file = File.join( Rails.root, 'config', 'mongodb.yml' )

mongo_configuration = if File.exists?( mongo_config_file)
  YAML.load(File.read( mongo_config_file ))['RAILS_ENV'] || 'localhost'
else
